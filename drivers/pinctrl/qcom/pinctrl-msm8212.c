...
static const struct pinctrl_pin_desc msm8212_pins[] = {
...
static const struct msm_function msm8212_functions[] = {
	FUNCTION(gpio),
	FUNCTION(cci_i2c0),
	FUNCTION(blsp_uim1),
	FUNCTION(blsp_uim3),
...
static const struct msm_pingroup msm8212_groups[] = {
...
static const struct msm_pinctrl_soc_data msm8212_pinctrl = {
	.pins = msm8212_pins,
	.npins = ARRAY_SIZE(msm8212_pins),
	.functions = msm8212_functions,
	.nfunctions = ARRAY_SIZE(msm8212_functions),
	.groups = msm8212_groups,
	.ngroups = ARRAY_SIZE(msm8212_groups),
	.ngpios = NUM_GPIO_PINGROUPS,
};

static int msm8212_pinctrl_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &msm8212_pinctrl);
}

static const struct of_device_id msm8212_pinctrl_of_match[] = {
	{ .compatible = "qcom,msm8212-pinctrl", },
	{ },
};

static struct platform_driver msm8212_pinctrl_driver = {
	.driver = {
		.name = "msm8212-pinctrl",
		.of_match_table = msm8212_pinctrl_of_match,
	},
	.probe = msm8212_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init msm8212_pinctrl_init(void)
{
	return platform_driver_register(&msm8212_pinctrl_driver);
}
arch_initcall(msm8212_pinctrl_init);

static void __exit msm8212_pinctrl_exit(void)
{
	platform_driver_unregister(&msm8212_pinctrl_driver);
}
module_exit(msm8212_pinctrl_exit);

MODULE_AUTHOR("Ivaylo Ivanov <ivo.ivanov@null.net>");
MODULE_DESCRIPTION("Qualcomm MSM8212 pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, msm8212_pinctrl_of_match);
